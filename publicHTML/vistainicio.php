<section id="blkBienvenida" class="row gx-0">
    ...
    <article class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-3">

        <p class="h-25 align-middle text">
...
<section id="carrusel" class="carousel slide mt-3" data-bs-ride="true">
